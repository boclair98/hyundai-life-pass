...
충전소와 블루핸즈는 위치 권한을 이미 허용한 경우 현재 위치로 자동 검색하고, 그렇지 않으면 기본 지역 결과를 보여준 뒤 버튼으로 현재 위치를 선택하게 합니다. 차량 케어의 7종 경고·차량 여권·공유 링크로 바로 이어집니다. 로그인 전에도 위치 기반 충전·정비 탐색은 사용할 수 있어 첫 화면에서 서비스 가치를 확인할 수 있습니다.
