...
export const mobilityScenes = [
  ...
  { id: 'charge', asset: '/journey/charge-v1', label: '다음 여정을 채우다' },
  { id: 'road', asset: '/journey/road-v1', label: '새로운 길을 만나다' },
  { id: 'care', asset: '/journey/care-v1', label: '오래 함께할 준비' },
  { id: 'parking', asset: '/journey/parking-v1', label: '여정이 머무는 곳' },
  { id: 'battery', asset: '/journey/battery-v1', label: '움직임의 에너지' },
  { id: 'tires', asset: '/journey/tires-v1', label: '길과 맞닿는 순간' },
  { id: 'journal', asset: '/journey/journal-v1', label: '차곡차곡 쌓인 시간' },
